...
function add_student($student_username, $student_password, $student_name, $student_email, $student_phone_number)
{
    ...
    $sql = "INSERT INTO student (username, password, name, email, phone_number) VALUES ('$student_username', '$student_password', '$student_name', '$student_email', '$student_phone_number')";
